<?php
/**
 * Tests for BH_WC_Gateway_Load_Balancer main setup class. Tests the actions are correctly added.
 *
 ...
 * Class Develop_Test
 */
class BH_WC_Gateway_Load_Balancer_Integration_Test extends \Codeception\TestCase\WPTestCase {
