...
class BH_WC_Gateway_Load_Balancer_Unit_Test extends \Codeception\Test\Unit {
	...
	/**
	 * @covers BH_WC_Gateway_Load_Balancer::set_locale
	 */
	public function test_set_locale_hooked() {
		...
		new BH_WC_Gateway_Load_Balancer();
	}

	/**
	 * @covers BH_WC_Gateway_Load_Balancer::define_admin_hooks
	 */
	...
	/**
	 * @covers BH_WC_Gateway_Load_Balancer::define_frontend_hooks
	 */
