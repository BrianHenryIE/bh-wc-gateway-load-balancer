 ...
 * @see Admin
 *
 * @package bh-wc-gateway-load-balancer
 ...
 * Class Admin_Test
 *
 * @covers \BH_WC_Gateway_Load_Balancer\Admin\Admin
 */
class Admin_Test extends \Codeception\Test\Unit {
	 ...
	 */
	private $plugin_name = 'bh-wc-gateway-load-balancer';
	...
	public function test_enqueue_styles() {
		...
		$css_file = $plugin_root_dir . '/admin/css/bh-wc-gateway-load-balancer-admin.css';
	...
	public function test_enqueue_scripts() {
		...
		$src       = $plugin_root_dir . '/admin/js/bh-wc-gateway-load-balancer-admin.js';
		$deps      = array( 'jquery' );
		$ver       = $this->version;
		$in_footer = true;
