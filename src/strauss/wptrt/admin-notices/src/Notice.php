...
namespace BH_WC_Gateway_Load_Balancer\WPTRT\AdminNotices;
...
class Notice {
	...
	/**
	 * An instance of the \BH_WC_Gateway_Load_Balancer\WPTRT\AdminNotices\Dismiss object.
	 *
	 * @access public
	 * @since 1.0
	 * @var \BH_WC_Gateway_Load_Balancer\WPTRT\AdminNotices\Dismiss
	 */
	public $dismiss;
