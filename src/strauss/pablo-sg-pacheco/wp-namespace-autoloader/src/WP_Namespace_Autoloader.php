...
namespace BH_WC_Gateway_Load_Balancer\Pablo_Pacheco\WP_Namespace_Autoloader;

if ( ! class_exists( '\BH_WC_Gateway_Load_Balancer\Pablo_Pacheco\WP_Namespace_Autoloader\WP_Namespace_Autoloader' ) ) {
	/**
